		...
		<>
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
					<Button
						variant="ghost"
						className="flex items-center gap-2 hover:bg-white/50 transition-all"
					>
						<Avatar
							className={`h-9 w-9 bg-gradient-to-br ${
				...
				<DropdownMenuContent
					align="end"
					className="w-72 bg-white/95 backdrop-blur-lg border-gray-200"
				>

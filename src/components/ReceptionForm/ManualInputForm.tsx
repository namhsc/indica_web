...
import { CheckCircle2, UserPlus, Phone, MapPin, Mail, Shield } from 'lucide-react';
...
interface ManualInputFormProps {
  ...
  onFormDataChange: (updates: Partial<ManualInputFormProps['formData']>) => void;
  onSubmit: () => void;
  hasPatientSelected: boolean;
}

export function ManualInputForm({ formData, onFormDataChange, onSubmit, hasPatientSelected }: ManualInputFormProps) {
      ...
      <form onSubmit={(e) => { e.preventDefault(); onSubmit(); }} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Select 
              ...
              onValueChange={(value) => onFormDataChange({ gender: value as Gender })}
            >
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={(e) => onFormDataChange({ insurance: e.target.value })}
        ...
        <div className="space-y-2">
          ...
          <Select 
            ...
            onValueChange={(value) => onFormDataChange({ assignedDoctorId: value })}
          >
            <SelectTrigger className="border-gray-300">

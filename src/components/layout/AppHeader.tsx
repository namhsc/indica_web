        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-primary">Phòng khám đa khoa Indica</h1>
                <p className="text-xs text-gray-600">Hệ thống quản lý phòng khám thông minh với AI</p>
              </div>
            </div>
          </div>
